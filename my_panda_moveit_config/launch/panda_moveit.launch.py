...
def launch_setup(context, *args, **kwargs):
    ...
    ompl_planning_yaml = load_yaml("my_panda_moveit_config", "config/ompl_planning.yaml")
    ompl_planning_pipeline_config["move_group"].update(ompl_planning_yaml)

    # Trajectory Execution Configuration
    controllers_yaml = load_yaml("my_panda_moveit_config", "config/controllers.yaml")
